# Gridsong: a Song-Maker-style classroom step sequencer that still works, saves, and exports (`gridsong`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://gridsong.sociobot.in`. Artifact class: `static-web`.
